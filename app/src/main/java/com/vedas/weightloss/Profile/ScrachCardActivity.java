...
public class ScrachCardActivity extends AppCompatActivity {
    ...
    public class ScrachCard extends RecyclerView.Adapter<ScrachCard.ViewHolder> {
        ...
        // step 5:-
        @Override
        public ScrachCard.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            ScrachCard.ViewHolder myViewHolder = new ScrachCard.ViewHolder(view, ctx, arrayList);
            return myViewHolder;
        ...
        //step 6:-
        @Override
        public void onBindViewHolder(final ScrachCard.ViewHolder holder, final int position) {
